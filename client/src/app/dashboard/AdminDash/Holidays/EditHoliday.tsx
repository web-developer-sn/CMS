    ...
    return (
        <div className="p-4">
            ...
            <div className="flex py-8 items-center">
                {!isMobile ? <h1 className="text-xl font-bold">Edit Holiday</h1> :
                    <Typography className="text-sm font-bold whitespace-nowrap">Edit Holiday</Typography>}
                <NavigateNextOutlinedIcon fontSize="small" />
                <HomeOutlinedIcon fontSize="small" />
                <NavigateNextOutlinedIcon fontSize="small" />
                <Typography fontSize={"small"}>Holiday</Typography>
                <NavigateNextOutlinedIcon fontSize="small" />
                <Typography fontSize={"small"}>Edit Holiday</Typography>
            </div>
