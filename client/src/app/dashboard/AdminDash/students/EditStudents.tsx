    ...
    return (
        <div className="p-4">
            ...
            <div className="flex py-8 items-center">
                {!isMobile ? <h1 className="text-xl font-bold">Edit Student</h1> :
                    <Typography className="text-sm font-bold whitespace-nowrap">Edit Student</Typography>}
                <NavigateNextOutlinedIcon fontSize="small" />
                <HomeOutlinedIcon fontSize="small" />
                <NavigateNextOutlinedIcon fontSize="small" />
                <Typography fontSize={"small"}>Student</Typography>
                <NavigateNextOutlinedIcon fontSize="small" />
                <Typography fontSize={"small"}>Edit Student</Typography>
            </div>
            ...
            <div className="bg-white p-6 rounded shadow">
                ...
                <form className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="registrationDate" required className="border rounded w-full px-3 py-2" />
                    </div>
                    <div>
                    ...
                    {/* Row 5 */}
                    <div>
                        <label className="block mb-1 font-medium">Parents name*</label>
                        <input type="text" name="parentsName" required className="border rounded w-full px-3 py-2" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="bloodGroup" className="border rounded w-full px-3 py-2" />
                    </div>
