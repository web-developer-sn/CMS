...
const AdmissionInquiry = () => {
    ...
    const [rowData] = useState<IAdmissionInquiry[]>([
        {
    ...
    const [columnDefs] = useState<ColDef[]>([
        ...
        { field: "name", headerName: "Student Name", minWidth: 160, flex: 1, cellRenderer: avatarCellRenderer },
        { field: "guardian", headerName: "Guardian Name", minWidth: 140, flex: 1, hide: isMobile },
        { field: "phone", headerName: "Contact Number", minWidth: 140, flex: 1, cellRenderer: phoneCellRenderer },
        { field: "email", headerName: "Email Address", minWidth: 200, flex: 1, cellRenderer: emailCellRenderer , hide: isMobile},
        { field: "inquiryDate", headerName: "Date of Inquiry", minWidth: 130, flex: 1 , hide: isMobile},
        { field: "source", headerName: "Inquiry Source", minWidth: 130, flex: 1, hide: isMobile },
        { field: "status", headerName: "Status", minWidth: 100, flex: 1, cellRenderer: statusCellRenderer },
        { field: "followUpDate", headerName: "Follow Up Date", minWidth: 130, flex: 1, hide: isMobile },
        { field: "assignedTo", headerName: "Assigned To", minWidth: 140, flex: 1, hide: isMobile },
        { field: "campus", headerName: "Campus Location", minWidth: 140, flex: 1, hide: isMobile },
        { field: "previousEducation", headerName: "Previous Education", minWidth: 180, flex: 1, hide: isMobile },
    ...
    return (
         <div className="p-4">
            <div className="flex py-4 items-center">
                {!isMobile ? <h1 className="text-xl font-bold">Admission Inquiry</h1> :
                    <Typography className="text-sm font-bold whitespace-nowrap">Admission Inquiry</Typography>}
                <NavigateNextOutlinedIcon fontSize="small" />
                <HomeOutlinedIcon fontSize="small" />
                <NavigateNextOutlinedIcon fontSize="small" />
                <Typography fontSize={"small"}>Frount</Typography>
                <NavigateNextOutlinedIcon fontSize="small" />
                <Typography fontSize={"small"}>Admission Inquiry</Typography>
            </div>

            <div className="bg-sky-100 py-4 dark:bg-sky-900 rounded-lg shadow">
                {/* Toolbar */}
                <div className="flex items-center justify-between">
                    {!isMobile && <Typography className="text-lg px-4">Admission Inquiry</Typography>}
