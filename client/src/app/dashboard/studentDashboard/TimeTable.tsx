...
const TimeTable = () => {
    ...
    const [rowData] = useState<ITimeTable[]>([
    ...
    const [columnDefs] = useState<ColDef<ITimeTable>[]>([
    ...
    return (
        <div className="p-4">
            <div className="flex py-4 items-center">
                {!isMobile ? <h1 className="text-xl font-bold">Timetable</h1> :
                    <Typography className="text-sm font-bold whitespace-nowrap">Timetable</Typography>}
                <NavigateNextOutlinedIcon fontSize="small" />
                <HomeOutlinedIcon fontSize="small" />
                <NavigateNextOutlinedIcon fontSize="small" />
                <Typography fontSize={"small"}>Student</Typography>
                <NavigateNextOutlinedIcon fontSize="small" />
                <Typography fontSize={"small"}>Timetable</Typography>
            </div>

            <div className="bg-sky-100 py-4 dark:bg-sky-900 rounded-lg shadow">
                <div className="flex items-center justify-between">
                    {!isMobile && <Typography className="text-lg px-4">Timetable</Typography>}
