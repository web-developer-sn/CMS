...
const Homework = () => {
    ...
    const [rowData] = useState<IHomework[]>([
    ...
    const [columnDefs] = useState<ColDef<IHomework>[]>([
    ...
    return (
        <div className="p-4">
            <div className="flex py-4 items-center">
                {!isMobile ? <h1 className="text-xl font-bold">Homework</h1> :
                    <Typography className="text-sm font-bold whitespace-nowrap">Homework</Typography>}
            ...
            <div className="bg-sky-100 py-4 dark:bg-sky-900 rounded-lg shadow">
                <div className="flex items-center justify-between">
                    {!isMobile && <Typography className="text-lg px-4">Homework</Typography>}
