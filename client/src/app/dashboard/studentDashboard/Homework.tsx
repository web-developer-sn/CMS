...
const Homework = () => {
  ...
  const [rowData,setRowData] = React.useState<IHomework[]>(
    [
    {
      subject: "Mathematics",
      className: "Class 1",
    ...
    <div className="p-4">
      <div className="flex py-4 items-center">
        {!isMobile ? (
          ...
          <Typography className="text-sm font-bold whitespace-nowrap">
            Homework
          </Typography>
        )}
        ...
        <NavigateNextOutlinedIcon fontSize="small" />
        <Typography fontSize={"small"}>Homework</Typography>
      </div>

      <div className="bg-sky-100 py-4 dark:bg-sky-900 rounded-lg shadow">
        <div className="flex items-center justify-between">
          {!isMobile && (
            <Typography className="text-lg px-4">Homework</Typography>
          )}
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              className={`bg-blue-500 text-white px-3 py-1 ${
                !isMobile && "mr-1"
              } rounded flex items-center space-x-1 text-sm`}
            >
        ...
        <div
          className="overflow-x-auto ag-theme-quartz"
          style={
            {
              ...gridStyle,
